...
namespace GModule {
	public ref struct Module
	{
		...
		public static explicit operator Module(IntPtr pointer) => new Module { _pointer = pointer };
...
;	}
	...
	public static class GModuleInterop {
		...
		public static extern int g_module_close(GModule.Module module);
		[DllImport("libgmodule-2.0.so.0")]
		...
		[DllImport("libgmodule-2.0.so.0")]
		public static extern int g_module_symbol(GModule.Module module, string symbol_name, System.IntPtr symbol);
		[DllImport("libgmodule-2.0.so.0")]
